...
def init_db():
    ...
    if not admin_user:
        execute_db(
            ...
            ("admin", admin_hash, "admin", "Administrateur", current_timestamp()),
        )
    else:
        execute_db(
...
def homework_page():
    ...
    if request.method == "POST":
        ...
        if form_type == "create":
            ...
            log_event("Devoir ajouté", user=user, details=title, entity_type="homework")
            flash("Devoir ajouté.")
            return redirect(url_for("homework_page"))
...
def absences_page():
    ...
    if request.method == "POST":
        ...
        if form_type == "create":
            ...
            log_event("Absence enregistrée", user=user, details=request.form.get("absence_date"), entity_type="absence")
